...
\begin{center}
	\begin{gantt}[xunitlength=1.5cm,fontsize=\small,titlefontsize=\small,drawledgerline=true]{7}{9}
		...
		\begin{ganttitle}
			...
			\titleelement{Sep}{1}
		\end{ganttitle}
		\ganttbar{Read paper-Wahlström}{0}{3}
		\ganttbarcon{Read paper-other papers}{2}{5}
		\ganttbarcon[color=red]{Write code}{5}{2}
		\ganttbarcon{Test code}{5.5}{2}
...
\begin{table*}[]
	\begin{tabular}{|l|l|l|l|l|}
		...
		\begin{tabular}[c]{@{}l@{}}It is hard to \\ finish a paper.\end{tabular}                                                                & Low         & \begin{tabular}[c]{@{}l@{}}Because completing the paper\\  requires completing the code\\  and completing the tests, \\ there is no point in completing \\ the paper if the above tasks \\ are not completed on time.\end{tabular}                                           & \begin{tabular}[c]{@{}l@{}}Inability to complete\\  the project\end{tabular}                                                           & \begin{tabular}[c]{@{}l@{}}Finishing the code section as early as \\ possible and finalizing the paper \\ earlier can effectively mitigate \\ this risk.\end{tabular}                         \\ \hline
	\end{tabular}
\end{table*}
\end{document}
