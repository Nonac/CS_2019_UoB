...
class GridBagLayoutDemo
{
    ...
    static void begin(JPanel panel)
    {
        ...
        GridBagLayout gbaglayout=new GridBagLayout();    //创建GridBagLayout布局管理器
        GridBagConstraints constraints=new GridBagConstraints();
        panel.setLayout(gbaglayout);    //使用GridBagLayout布局管理器
        constraints.fill=GridBagConstraints.BOTH;    //组件填充显示区域
        constraints.weightx=0.0;    //恢复默认值
        constraints.gridwidth = GridBagConstraints.REMAINDER;

        JTextField tf=new JTextField("You want a PVP or PVE? ");
        tf.setFont(f);
        ...
        JButton buttony=new JButton("yes");    //创建Button对象
        buttony.setFont(f);
        gbaglayout.setConstraints(buttony,constraints);

        JButton buttonn=new JButton("no");    //创建Button对象
        buttonn.setFont(f);
    ...
    static void begintwo(JPanel panel,GridBagLayout gbaglayout)
    {
        Font f=new Font("Times",Font.BOLD,20);
        GridBagConstraints constraints=new GridBagConstraints();
        panel.setLayout(gbaglayout);    //使用GridBagLayout布局管理器
